...
*Key concepts applied in my academic and personal projects.*

| **Inference & Hypothesis** | **Modeling & Prediction** | **Multivariate Analysis** |
| :--- | :--- | :--- |
| • Hypothesis Testing (t-test, ANOVA) <br> • A/B Testing Design <br> • Confidence Intervals <br> • p-value Interpretation | • Multiple Linear Regression (OLS) <br> • Logistic Regression <br> • Time Series Decomposition <br> • Residual Analysis | • PCA (Principal Component Analysis) <br> • K-Means Clustering <br> • Factor Analysis <br> • Dimension Reduction |
